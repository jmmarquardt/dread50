...
public class LevelGenerator : MonoBehaviour 
{
	...
	// Size of the total square maze (total length or width units)
	public int mazeSize;
	...
	void Start () 
	{
		...
		// grab level text from canvas and update to current level 
		levelText.text = "Level " + DontDestroy.currentLevel;
